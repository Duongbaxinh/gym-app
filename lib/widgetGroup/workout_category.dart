  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<WorkOutPlanProvider>(
        builder: (BuildContext context, WorkOutPlanProvider workoutCategory,
                Widget? child) =>
            FutureBuilder<void>(
              future: workoutProvider.init(),
              builder: (context, snapshot) {
                List<WorkPlanModel> workPlanCategories =
                    workoutProvider.workPlanCategories;
                return Column(
                  children: [
                    Container(
                    ...
                    !workoutProvider.isLoading
                        ? Container(
                            constraints: BoxConstraints(
                              maxHeight: scrollDirection != null
                            ...
                            child: ListView.separated(
                                shrinkWrap:
                                    scrollDirection != null ? true : false,
                                ...
                                itemBuilder: (context, index) => InkWell(
                                      onTap: () async {
                                        ...
                                        if (workPlanCategories[index].state ==
                                                'publish' ||
                                            infoUser['premium']) {
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: CardLesson(
                                            state:
                                                workPlanCategories[index].state,
                                            titleLesson:
                                                workPlanCategories[index]
                                                    .namePlan,
                                            subLesson: workPlanCategories[index]
                                                .timeDetail,
                                            thumbnail: workPlanCategories[index]
                                                .thumbnail),
                                      ),
                                    ),
