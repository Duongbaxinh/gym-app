...
Map<String, dynamic> warmUp = {
  ...
  "numberOfLesson": "2",
  "background":
      "https://res.cloudinary.com/dwu92ycra/image/upload/v1700896412/Gym-app/Image_11_tisyhe.png",
          ...
          child: Column(
            ...
            children: [
              ListTile(
                ...
                title: Text(
                  workPlanModel.namePlan.trim(),
                  style: titleStyle,
                ),
                subtitle: Text(
                  workPlanModel.describe,
                  style: subStyle,
                ),
              ),
              Row(
                children: [
                  Chip(
                      avatar: ImageIcon(NetworkImage(timeIcon)),
                      label: Text('${workPlanModel.totalTime} min')),
                  const SizedBox(
                    width: 50,
                  ),
                  Chip(
                      avatar: ImageIcon(NetworkImage(calIcon)),
                      label: Text('${workPlanModel.totalCalo} cal')),
                ],
              ),
              Container(
                padding: const EdgeInsets.symmetric(vertical: 20),
                child: Text(
                  workPlanModel.description,
                  maxLines: 6,
                          ...
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) => VideoScreen(
                                  lesson: workPlanModel.lessons![index],
                                  lessons: workPlanModel.lessons ?? [],
                                ),
                              ));
                        },
                        child: CategoryLesson(
                            titleCategory:
                                workPlanModel.lessons![index].nameLesson!,
                            typeLesson:
                                workPlanModel.lessons![index].typeLesson!,
        ...
        child: BottomButton(
          ...
          fn: () {
            Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) => VideoScreen(
                      lesson: workPlanModel.lessons![0],
                      lessons: workPlanModel.lessons!),
                ));
          },
        ),
