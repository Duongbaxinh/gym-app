...
class RattingScreen extends StatefulWidget {
  ...
  const RattingScreen(
      {super.key,
      required this.rattingCalculate,
          ...
          child: BottomButton(
            ...
            fn: () {
              Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        WriteCommentScreen(idTrainer: widget.idTrainer),
                  ));
            },
            heightOver: 120,
          )),
        ...
        child: Column(
          children: [
              ...
              child: Row(
                children: [
                  Expanded(
                      ...
                      child: Center(
                          child: Text(
                        widget.rattingCalculate['mean'].toStringAsFixed(1),
                        style: labelTitle.copyWith(fontSize: 48),
                      ))),
                  Expanded(
                    flex: 3,
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          RateCustom(
                              label: '5',
                              ratting:
                                  ((widget.rattingCalculate['5'] ?? 0) * 10)
                                      .toDouble(),
                              size: 2,
                              height: 10),
                          RateCustom(
                            label: '4',
                            ratting: ((widget.rattingCalculate['4'] ?? 0) * 10)
                                .toDouble(),
                            size: 2,
                            height: 10,
                          ),
                          RateCustom(
                            label: '3',
                            ratting: ((widget.rattingCalculate['3'] ?? 0) * 10)
                                .toDouble(),
                            size: 2,
                            height: 10,
                          ),
                          RateCustom(
                            label: '2',
                            ratting: ((widget.rattingCalculate['2'] ?? 0) * 10)
                                .toDouble(),
                            size: 2,
                            height: 10,
                          ),
                          RateCustom(
                            label: '1',
                            ratting: ((widget.rattingCalculate['1'] ?? 0) * 10)
                                .toDouble(),
                            size: 2,
                            height: 10,
                          ),
            ...
            Align(
              ...
              child:
                  Text('${widget.rattingCalculate.length!.toString()} Ratings'),
            ),
            const SizedBox(
              height: 35,
            ),
