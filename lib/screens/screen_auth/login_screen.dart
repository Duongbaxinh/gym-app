...
import 'package:project_app/screens/screen_auth/forgot_password_screen.dart';
            ...
            children: [
              const AspectRatio(
                ...
                child: PageHeader(
                    ...
                    image:
                        'https://res.cloudinary.com/dwu92ycra/image/upload/v1700476786/bg_login_oxejpc.png'),
              ),
              Padding(
                padding:
              ...
              Padding(
                ...
                child: FooterAuth(
                    ...
                    fn3: () {
                      ...
                      if (check) {
                        userProvider.login(_textEditingControllerEmail.text,
