...
class TrainerProvider with ChangeNotifier{
  ...
  Future<TrainerModel> getTrainerById(String id) async {
    ...
    CollectionReference<Map<String,dynamic>> trainerRef = fireStore.collection('trainer');
    DocumentSnapshot<Map<String,dynamic>> trainerSnapshot = await trainerRef.doc(id).get();
